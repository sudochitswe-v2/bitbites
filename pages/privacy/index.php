...
<body style="background: var(--primary);">
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <h2>Introduction</h2>
                <p>Your privacy is important to us. This privacy policy explains how we collect, use, protect, and handle your personal information in connection with our website.</p>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12">
                ...
                <ul>
                    ...
                    <li><strong>Usage Data:</strong> Information on how you use our website, such as your IP address, browser type, and pages visited.</li>
        ...
        <div class="row mt-4">
            <div class="col-12">
                ...
                <p>We take the security of your data seriously. We implement a variety of security measures to maintain the safety of your personal information.</p>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12">
